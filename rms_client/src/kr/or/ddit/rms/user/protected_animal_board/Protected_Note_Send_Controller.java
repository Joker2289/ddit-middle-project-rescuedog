...
public class Protected_Note_Send_Controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
			idTo_tf.setText(ProtectedBoard_Cotroller.writer_lb.getText());
...
//				ProtectedBoard_Cotroller.WritePage.close();
//			}
//		});
		close_btn1.setOnAction(new EventHandler<ActionEvent>() {
