...
public class Break_AwayController implements Initializable {

	public static MemberVO membervo;
	
	@FXML Label out_id_label;
	@FXML JFXPasswordField out_pw_txt;
	@FXML JFXPasswordField out_pwcheck_txt;
		...
		mypage_out_btn.setOnAction(e -> {
			...
			try {
				...
				if (out_pw_txt.getText().isEmpty() != false) {
					...
					boolean delcheck = alertConfirm("탈퇴하시면 모든 정보가 날라가게 됩니다. 탈퇴하시겠습니까?");
