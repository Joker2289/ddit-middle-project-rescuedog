...
public class Review_board_detailSController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		review_comment_name_textfield.setText(Login_controller.log_s.getShel_name());
		...
		review_del_btn.setOnAction(e -> {
			...
			if (delcheck) {
				try {
					Main.rb_s.deleteBoard_detail(Review_board_detailSController.vo);
					ChangePane cp = Main_page_controller.fxmlLoad.getController();
					cp.clearing();
					ChangePane.changePane(getClass().getResource("review_board_table.fxml"));
					cp.add();
