...
public class S_adopt_detail_view_controller implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		RD_log = S_adopt_view_controller.log_img.getAccessibleText().split("/");
		
		show_info();
		
		Adopt_Request_Btn.setVisible(false);
		Goto_Adopt.setOnAction(e->{
			S_adopt_view_controller.adopt_view_dialog.close();
		});
	}
