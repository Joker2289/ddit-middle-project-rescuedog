...
public class Share_detailSController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		share_comment_name_textfield.setText(Login_controller.log_s.getShel_name());
		...
		share_del_btn.setOnAction(e -> {
			...
			if (delcheck) {
				try {
					Main.sib_s.deleteBoard_detail(Share_detailSController.vo);
					ChangePane cp = Main_page_controller.fxmlLoad.getController();
					cp.clearing();
					ChangePane.changePane(getClass().getResource("share_table.fxml"));
					cp.add();
