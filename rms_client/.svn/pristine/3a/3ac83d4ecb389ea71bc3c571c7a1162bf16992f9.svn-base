...
public class Main_page_controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		Main_Mypage_btn.setOnAction(e -> {
			if(Login_controller.log.getMem_author().equals("1")) {
				ChangePane.selFxml = "activeList_main.fxml";
				ChangePane.fxmlClass = Active_controller.class;
		...
		Main_MM_Btn.setOnAction(e -> {
			ChangePane.selFxml = "member_manage.fxml";
			ChangePane.fxmlClass = Member_managementController.class;
			loadPaneSel(ChangePane.class.getResource("mainPane.fxml"));
			Main_Manu_Drawer.close();
		});
		Main_Manu_Drawer.close();
	...
	private void menuSel(Node node) {
		node.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
			...
			case "공지 사항1":
				...
				ChangePane.fxmlClass = INoticeUserService.class;
				loadPaneSel(ChangePane.class.getResource("mainPane.fxml"));
				break;
			case "1 : 1 문의1":
				System.out.println(node.getAccessibleText());
			...
			case "공지 사항2":
				ChangePane.selFxml = "notice_table.fxml";
				ChangePane.fxmlClass = INoticeShelService.class;
				loadPaneSel(ChangePane.class.getResource("mainPane.fxml"));
				System.out.println(node.getAccessibleText());
				break;
			...
			case "상품 관리3":
				ChangePane.selFxml = "add_goods.fxml";
				ChangePane.fxmlClass = Add_goods_controller.class;
				loadPaneSel(ChangePane.class.getResource("mainPane.fxml"));
				System.out.println(node.getAccessibleText());
				break;
