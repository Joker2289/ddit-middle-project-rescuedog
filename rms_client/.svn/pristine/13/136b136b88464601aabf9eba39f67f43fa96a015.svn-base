...
public class Free_board_detailUController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		freeboard_content_wv.setDisable(true);
		...
		freeboard_comment_name_textfield.setText(Login_controller.log_c.getCustom_name());
		...
		freeboard_del_btn.setOnAction(e->{
			...
			if(delcheck) {
				try {
					Main.fb_u.deleteBoard_detail(Free_board_detailUController.vo);
