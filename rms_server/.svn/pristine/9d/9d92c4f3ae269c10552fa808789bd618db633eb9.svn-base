...
public class Sharing_info_boardUDaoImpl implements Sharing_info_boardUDao {

	private static Sharing_info_boardUDaoImpl dao;

	private SqlMapClient smc;

	private Sharing_info_boardUDaoImpl() {
		smc = XmlConnection.getConnection();
	}

	public static Sharing_info_boardUDaoImpl getInstance() {
		if (dao == null) {
			dao = new Sharing_info_boardUDaoImpl();
		}
		return dao;
	}
