...
public class Review_boardUDaoImpl implements Review_boardUDao {

	private static Review_boardUDaoImpl dao;

	private SqlMapClient smc;

	private Review_boardUDaoImpl() {
		smc = XmlConnection.getConnection();
	}

	public static Review_boardUDaoImpl getInstance() {
		if (dao == null) {
			dao = new Review_boardUDaoImpl();
		}
		return dao;
	}
