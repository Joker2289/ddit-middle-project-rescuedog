...
public class Sharing_info_boardSDaoImpl implements Sharing_info_boardSDao {

	private static Sharing_info_boardSDaoImpl dao;

	private SqlMapClient smc;

	private Sharing_info_boardSDaoImpl() {
		smc = XmlConnection.getConnection();
	}

	public static Sharing_info_boardSDaoImpl getInstance() {
		if (dao == null) {
			dao = new Sharing_info_boardSDaoImpl();
		}
		return dao;
	}
