...
public class Free_boardSDaoImpl implements Free_boardSDao {

	private static Free_boardSDaoImpl dao;

	private SqlMapClient smc;

	private Free_boardSDaoImpl() {
		smc = XmlConnection.getConnection();
	}

	public static Free_boardSDaoImpl getInstance() {
		if (dao == null) {
			dao = new Free_boardSDaoImpl();
		}
		return dao;
	}
