...
public class ProtectedBoardDaoImpl implements IProtectedBoardDao {
	...
	@Override
	public int insertBoard(Protected_boardVO bv) {
		int cnt = 0;
		try {

			Object obj = smc.insert("protected.insertboard", bv);
			if (obj == null) {
				cnt = 1;
			}
	...
	@Override
	public int updateBoard(Protected_boardVO bv) {
		int cnt = 0;
		try {

			cnt = smc.update("protected.updateboard", bv);
