...
public class Sharing_info_boardUServiceImpl extends UnicastRemoteObject
		implements Sharing_info_boardUService, Serializable {
	Sharing_info_boardUDao dao;

	public Sharing_info_boardUServiceImpl() throws RemoteException {
		dao = Sharing_info_boardUDaoImpl.getInstance();
	}
